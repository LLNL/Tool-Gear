...
extern INT_ARRAY_Symbol_Table *INT_ARRAY_new_symbol_table (const char *name, 
							   int expected_size);
extern void INT_ARRAY_delete_symbol_table (INT_ARRAY_Symbol_Table *table, 
					   void (*free_routine)(void *));
extern INT_ARRAY_Symbol *INT_ARRAY_add_symbol (INT_ARRAY_Symbol_Table *table, 
					       int *int_array, 
					       int array_length, void *data);
extern INT_ARRAY_Symbol *INT_ARRAY_find_symbol (INT_ARRAY_Symbol_Table *table, 
						int *int_array, 
						int array_length);
