...
typedef struct L_Alloc_Pool_Header
{
        struct L_Alloc_Pool_Header   *next;
} L_Alloc_Pool_Header;

typedef struct L_Alloc_Pool
{
    char                        *name;
    int                         element_size;     
    int				block_size;  /* Block size to allocate */
    int                         num_in_block;/* Num elements in block */
    struct L_Alloc_Pool_Header  *head;       /* Pointer to head of free list*/
    int                         allocated;   /* Number allocated */
    int                         free;        /* Number free */
    int				blocks_allocated; 
    struct L_Alloc_Pool_Header	*block_list; /* Pointer to blocks allocated */
    int				bypass_routines;
} L_Alloc_Pool;
...
extern void L_print_alloc_info(FILE *, L_Alloc_Pool *, int);
